                ...
                <div class="flex h-full">
                    <div class="flex-[2] p-3">
                        ...
                        <div class="flex-1 relative">
                            <div class="flex relative justify-center place-items-center aspect-square border border-gray-300 rounded-lg mb-5 bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                <img src="{{ $teacher->image() }}" class="object-cover aspect-square rounded-lg" name="profile" alt="Profile Preview" id="preview">
                                <p id="profile-tag" class="block text-sm font-medium text-gray-700 mb-1 hidden">Profile Picture</p>
                    ...
                    <div class="flex-[3] border-l border-gray-400 p-4">
                        ...
                        <div class="grid gap-2">
                            <div class="relative">
                                ...
                                <input value="{{ $teacher->rfid }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('rfid') border-red-500 @enderror" type="text" name="rfid" id="rfid" readonly>
                            ...
                            <div class="relative">
                                ...
                                <input value="{{ $teacher->employee_id }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('employee_id') border-red-500 @enderror" type="text" name="employee_id" id="employee_id">
                        ...
                        <div class="grid gap-3.5 gap-y-2 mt-2">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="relative">
                                    ...
                                    <input value="{{ $teacher->first_name }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('first_name') border-red-500 @enderror" type="text" name="first_name" id="firstname">
                                    @error('first_name')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                                </div>

                                <div class="relative">
                                    <label class="block text-sm font-medium text-gray-700" for="middlename">Middle Name</label>
                                    <input value="{{ $teacher->middle_name }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('middle_name') border-red-500 @enderror" type="text" name="middle_name" id="middlename">
                            ...
                            <div class="relative">
                                ...
                                <input value="{{ $teacher->last_name }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('last_name') border-red-500 @enderror" type="text" name="last_name" id="lastname">
                        ...
                        <div class="flex gap-4 items-end mt-1">
                            <div class="flex-1 relative">
                                ...
                                <input value="{{ $teacher->phone_number }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('phone_number') border-red-500 @enderror" type="tel" name="phone_number" id="phone">
                        ...
                        <div class="flex gap-4 items-start mt-2">
                            ...
                            <div class="flex-1 relative">
                                ...
                                <input value="{{ $teacher->birthdate }}" class="w-full px-3 py-1.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('birthdate') border-red-500 @enderror" type="date" name="birthdate" id="birthdate">
                    ...
                    <div class="flex-[3] border-l border-gray-400 p-4">
                        ...
                        <div class="grid gap-2">
                            <div class="relative">
                                ...
                                <input value="{{ $teacher->username }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('username') border-red-500 @enderror" type="text" name="username" id="username">
                            ...
                            <div class="relative">
                                ...
                                <select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('department') border-red-500 @enderror" name="department" id="department">
                                    ...
                                    <option value="{{ $department->id }}" {{ $teacher->department_id == $department->id ? 'selected' : '' }}>{{ $department->name }} ({{ $department->code }})</option>
                                    @endforeach
                                </select>
