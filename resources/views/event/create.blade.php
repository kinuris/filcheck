...
<div class="w-full p-6 bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 max-h-screen overflow-auto">
    <div class="max-w-6xl mx-auto">
        <h1 class="text-4xl font-bold text-white mb-8 border-b pb-4">Create Event</h1>
            ...
            <div class="flex flex-col space-y-6">
                <div class="grid grid-cols-2 gap-6">
                    <div class="flex flex-col">
                        ...
                        <input value="{{ old('name') }}" class="border @error('name') border-red-600 @else border-gray-300 @enderror rounded-lg bg-white/90 p-3 focus:outline-none focus:ring-2 focus:ring-blue-400" type="text" name="name" id="name">
                        @error('name')
                    ...
                    <div class="flex flex-col">
                        ...
                        <input value="{{ old('address') }}" class="border @error('address') border-red-600 @else border-gray-300 @enderror rounded-lg bg-white/90 p-3 focus:outline-none focus:ring-2 focus:ring-blue-400" type="text" name="address" id="address">
                        @error('address')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex flex-col">
                    ...
                    <textarea class="border @error('description') border-red-600 @else border-gray-300 @enderror rounded-lg bg-white/90 p-3 h-32 focus:outline-none focus:ring-2 focus:ring-blue-400" name="description" id="description">{{ old('description') }}</textarea>
                    @error('description')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="flex flex-col">
                        ...
                        <input value="{{ old('start') }}" class="border @error('start') border-red-600 @else border-gray-300 @enderror rounded-lg bg-white/90 p-3 focus:outline-none focus:ring-2 focus:ring-blue-400" type="datetime-local" name="start" id="start">
                        @error('start')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="flex flex-col">
                        ...
                        <input value="{{ old('end') }}" class="border @error('end') border-red-600 @else border-gray-300 @enderror rounded-lg bg-white/90 p-3 focus:outline-none focus:ring-2 focus:ring-blue-400" type="datetime-local" name="end" id="end">
                        @error('end')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
