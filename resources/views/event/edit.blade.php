...
<div class="w-full p-8 bg-gradient-to-r from-blue-700 to-blue-900 max-h-screen overflow-auto">
    <div class="max-w-6xl mx-auto bg-white rounded-xl shadow-2xl p-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6 flex items-center">
            <i class="fas fa-calendar-edit mr-3 text-blue-600"></i>Edit Event
        </h1>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex flex-col">
                        ...
                        <input value="{{ $event->name }}" class="border @error('name') border-red-500 @else border-gray-300 @enderror rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" name="name" id="name">
                        @error('name')
                    ...
                    <div class="flex flex-col">
                        ...
                        <input value="{{ $event->address }}" class="border @error('address') border-red-500 @else border-gray-300 @enderror rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" name="address" id="address">
                        @error('address')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex flex-col">
                    ...
                    <textarea class="border @error('description') border-red-500 @else border-gray-300 @enderror rounded-lg p-3 h-32 focus:outline-none focus:ring-2 focus:ring-blue-500" name="description" id="description">{{ $event->description }}</textarea>
                    @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex flex-col">
                        ...
                        <input value="{{ $event->start }}" class="border @error('start') border-red-500 @else border-gray-300 @enderror rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500" type="datetime-local" name="start" id="start">
                        @error('start')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="flex flex-col">
                        ...
                        <input value="{{ $event->end }}" class="border @error('end') border-red-500 @else border-gray-300 @enderror rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500" type="datetime-local" name="end" id="end">
                        @error('end')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
