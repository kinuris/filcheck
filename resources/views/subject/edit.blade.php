...
<div class="w-full p-6 bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 max-h-screen overflow-auto">
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <form class="bg-white p-8 shadow-2xl rounded-lg" action="{{ route('subject.update', $subject->id) }}" method="POST">
                <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Subject</h1>
                @csrf
                <div class="space-y-6">
                    <div>
