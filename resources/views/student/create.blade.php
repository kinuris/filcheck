                                ...
                                <div class="pt-4 border-t border-gray-200">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input value="{{ old('section') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 uppercase @error('section') border-red-500 @enderror" type="text" name="section" id="section">
