    ...
    <div class="w-full inline-block min-h-[calc(100%-4rem)] max-h-[calc(100%-1rem)] overflow-auto bg-white">
        ...
        <div class="p-6 bg-gradient-to-r from-blue-500 to-blue-600">
            <div class="rounded-xl shadow-2xl bg-white min-h-[calc(100%-4rem)] max-h-[calc(100%-1rem)] overflow-auto">
                <form action="/student/create" enctype="multipart/form-data" method="POST" class="h-full">
                    @csrf
                    <div class="flex h-full">
                        <div class="flex-[2] p-4 bg-gray-50">
                            ...
                            <div class="flex relative justify-center place-items-center aspect-square border-2 border-dashed border-blue-300 rounded-xl mb-4 bg-gray-50 hover:border-blue-500 transition-colors @error('profile') border-red-500 @enderror">
                                ...
                                <p class="text-red-500 text-xs mt-1 absolute -bottom-4">@error('profile') {{ $message }} @enderror</p>
                            </div>
                        ...
                        <div class="flex-[3] border-l border-gray-200 p-4">
                            ...
                            <div class="grid gap-4">
                                ...
                                <div class="relative">
                                    ...
                                    <input value="{{ old('student_number') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('student_number') border-red-500 @enderror" type="text" name="student_number" id="student_number">
                        ...
                        <div class="flex-[3] border-l border-gray-200 p-4">
                            ...
                            <div class="grid gap-4">
                                ...
                                <div class="relative">
                                    ...
                                    <input value="{{ old('guardian') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('guardian') border-red-500 @enderror" type="text" name="guardian" id="guardian">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 min-h-24 @error('address') border-red-500 @enderror" name="address" id="address">{{ old('address') }}</textarea>
                                    ...
                                    <div class="grid grid-cols-10 gap-4">
                                        ...
                                        <div class="col-span-2 relative">
                                            ...
                                            <select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('section_letter') border-red-500 @enderror" name="section_letter" id="section_letter">
                                                <option value="A" {{ old('section_letter') == 'A' ? 'selected' : '' }}>A</option>
                                                <option value="B" {{ old('section_letter') == 'B' ? 'selected' : '' }}>B</option>
                                                <option value="C" {{ old('section_letter') == 'C' ? 'selected' : '' }}>C</option>
                                                <option value="D" {{ old('section_letter') == 'D' ? 'selected' : '' }}>D</option>
                                                <option value="E" {{ old('section_letter') == 'E' ? 'selected' : '' }}>E</option>
                                            </select>
                                ...
                                <div class="flex justify-end gap-4 mt-4">
                                    ...
                                    <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium">Save Student</button>
                                </div>
                            </div>
                        </div>
                    </div>
